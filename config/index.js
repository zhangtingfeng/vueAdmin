...
module.exports = {
  dev: {
    ...
    proxyTable: {
      '/tools-service': {
        target: 'http://localhost:48020',//设置你调用的接口域名和端口号npm run eureka 48001    npm run dev 48028   别忘了加http'http://localhost:38030'  http://api.edu.eggsoft.cn
        changeOrigin: true,
        pathRewrite: {
      ...
      '/apis': {
        target: 'http://localhost:48001',//设置你调用的接口域名和端口号npm run eureka 48001    npm run dev 48028   别忘了加http'http://localhost:38030'  http://api.edu.eggsoft.cn
        changeOrigin: true,
        pathRewrite: {

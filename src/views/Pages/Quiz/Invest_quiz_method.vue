  ...
  <div class="page-container">
    ...
    <div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
      <el-form :inline="true" :model="filters" :size="size" ref="filters" class="form">
        ...
        <el-form-item prop="Sort">
          <el-input auto-complete="off" placeholder="排序编号" v-model="filters.Sort"></el-input>
        </el-form-item>
        ...
        <el-form-item>
          <kt-button icon="el-icon-s-check" label="新增" type="primary" @click="addQuiz_Method"/>
          <kt-button
            icon="fa fa-search"
            label="查询"
            type="primary"
    ...
    <el-dialog title="题目详情" width="70%" :visible.sync="dialogVisible" :close-on-click-modal="false">
      ...
      >
        ...
        <el-form-item label="题目是否在线" prop="Status">
        ...
        <el-form-item label="底限分数" prop="lowScore">
          <el-input auto-complete="off" type="number" placeholder="计分的起始值间隔"
                    v-model="dataForm.lowScore"></el-input>
        </el-form-item>

        <el-form-item label="高限分数" prop="hightScore">
          <el-input auto-complete="off" type="number" placeholder="计分的中止值区间间隔"
                    v-model="dataForm.hightScore"></el-input>
        </el-form-item>
      </el-form>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            addQuiz_Method: function (params) {
                let this_ = this;
            ...
            submitForm: function () {
                ...
                this_.$refs.dataForm.validate(valid => {
                    if (valid) {
                        ...
                        params.t = "invest_quiz_score_method";
            ...
            handleDelete: function (data) {
                ...
                data.t = "invest_quiz_score_method";
                data.ids = ids;
            ...
            querypageList() {
                var that = this;
                this.utils.request.querypageList({t: "invest_quiz_score_method"}, function (data) {
            ...
            async findDicType() {
                ...
                _thisvar.limit = 100;
                _thisvar.status = "";
                _thisvar.t = "invest_quiz";
                _thisvar.sql = "queryList";
